...
const ProfileTabs = () => {
  ...
  return (
    <div className="flex space-x-4 border-b">
      <Link to="/profile/claims" className={location.pathname.startsWith("/profile/claims") ? "font-bold border-b-2" : ""} >My Claims</Link>
      ...
      <Link to="/profile/my-positions" className={location.pathname.startsWith("/profile/my-positions") ? "font-bold border-b-2" : ""} >My Positions</Link>
