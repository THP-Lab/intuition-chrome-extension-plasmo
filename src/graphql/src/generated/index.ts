...
export type AccountClaimsAggregateFragment = {
  ...
  claims_aggregate: {
    ...
    nodes: Array<{
      ...
      shares: any
      counter_shares: any
      triple: { __typename?: "triples"; id: any }
    }>
  }
}
  ...
  positions_aggregate: {
    ...
    nodes: Array<{
      ...
      vault: {
        ...
        triple?: { __typename?: "triples"; id: any } | null
      }
    }>
  }
}
...
export type GetTriplesWithPositionsThpQueryVariables = Exact<{
  limit?: InputMaybe<Scalars["Int"]["input"]>
  offset?: InputMaybe<Scalars["Int"]["input"]>
  orderBy?: InputMaybe<Array<Triples_Order_By> | Triples_Order_By>
  where?: InputMaybe<Triples_Bool_Exp>
...
export type GetTriplesWithPositionsThpQuery = {
  __typename?: "query_root"
  total: {
    __typename?: "triples_aggregate"
    aggregate?: {
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          { kind: "Field", name: { kind: "Name", value: "vault_id" } },
          { kind: "Field", name: { kind: "Name", value: "counter_vault_id" } },
          {
            kind: "Field",
            name: { kind: "Name", value: "vault" },
            selectionSet: {
                                    ...
                                    selectionSet: {
                                      ...
                                      selections: [
                                        ...
                                        },
                                        {
                                          ...
                                          name: {
                                            kind: "Name",
                                            value: "as_object_triples_aggregate"
                                          },
                                          selectionSet: {
                                            kind: "SelectionSet",
                                            selections: [
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetTriplesWithPositionsTHP" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
